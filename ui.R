    ...
    tabPanel('Model', icon = icon('cogs'),
             ...
             tabItem("modelpara",   
                     ...
                     box(title = "Model Local Interpretations: LIME", width=12, status = 'primary', solidHeader = TRUE,
                         #sliderInput('obs',label = 'Choose observation for Lime',  min = 1, max = 120, value = 10 ),
                         selectInput("obs","SELECT OBSERVATION:", character(0), multiple = FALSE),
                         plotOutput('lime',height=400)
                         ))
